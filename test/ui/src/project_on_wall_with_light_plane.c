...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   project_on_wall_with_light_plane.c                 :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gmachado <gmachado@student.42sp.org.br>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/20 17:15:20 by gmachado          #+#    #+#             */
/*   Updated: 2023/10/04 12:07:39 by gmachado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			t_trace_args *t)
{
	...
	get_point_light(&t->phong.light, &(t_vec3){.x = -2, .y = 10, .z = 50},
...
void	trace_all(t_args *args, t_trace_args *t)
{
	...
	rotate_x = matrix_rotate_x(-M_PI / 50.0);
	set_plane(&t->obj, matrix_multiply(rotate_x, id), &t->phong.material);
	y = 0;
