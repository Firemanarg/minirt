...
/*   Updated: 2023/10/12 04:47:58 by gmachado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			t_trace_args *t)
{
	...
	get_point_light(&t->light, &(t_vec3){.x = -2, .y = 10, .z = 50},
...
void	trace_all(t_args *args, t_trace_args *t)
{
	...
	set_plane(&t->obj, matrix_multiply(rotate_x, id), &t->phong.obj->material);
	y = 0;
