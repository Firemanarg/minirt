...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   project_on_wall_with_light_cone.c                  :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gmachado <gmachado@student.42sp.org.br>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/20 17:15:20 by gmachado          #+#    #+#             */
/*   Updated: 2023/10/06 19:57:30 by gmachado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			t_trace_args *t)
{
	...
	get_point_light(&t->phong.light, &(t_vec3){.x = 0, .y = 0, .z = 10},
...
void	trace_all(t_args *args, t_trace_args *t)
{
	...
	rotate_x = matrix_rotate_x(M_PI_4);
	rotate_z = matrix_rotate_z(M_PI_4);
	transform = matrix_multiply(rotate_x, id);
	set_cone(&t->obj, matrix_multiply(rotate_z, transform), &t->phong.material);
	set_cone_limits(&t->obj, -0.7, 0.7, TRUE);
	y = 0;
