...
Test(shadow, nothing_collinear_no_shadow)
{
	...
	set_vec3(0.0, 10.0, 0.0, &comps.over_point);
	is_shadowed(&world, world.lights, &comps, xs);
...
Test(shadow, object_between_point_and_light_shadow)
{
	...
	xs = new_array(8);
	set_default_world(&world);
	set_vec3(10.0, -10.0, 10.0, &comps.over_point);
	is_shadowed(&world, world.lights, &comps, xs);
...
Test(shadow, object_behind_light_no_shadow)
{
	...
	xs = new_array(8);
	set_default_world(&world);
	set_vec3(-20.0, 20.0, -20.0, &comps.over_point);
	is_shadowed(&world, world.lights, &comps, xs);
	cr_expect(eq(int, comps.in_shadow, FALSE));
	free_world(&world);
	free_array(xs);
...
Test(shadow, object_behind_point_no_shadow)
{
	...
	xs = new_array(8);
	set_default_world(&world);
	set_vec3(-2.0, 2.0, -2.0, &comps.over_point);
	is_shadowed(&world, world.lights, &comps, xs);
	cr_expect(eq(int, comps.in_shadow, FALSE));
	free_world(&world);
	free_array(xs);
